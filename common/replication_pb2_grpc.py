...
class ReplicationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReplicateMessage = channel.unary_unary(
                '/common.ReplicationService/ReplicateMessage',
        ...
        self.Ping = channel.unary_unary(
                '/common.ReplicationService/Ping',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=replication__pb2.PingResponse.FromString,
                _registered_method=True)
...
def add_ReplicationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Ping': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=replication__pb2.PingResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'common.ReplicationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('common.ReplicationService', rpc_method_handlers)
...
class ReplicationService(object):
    ...
    def ReplicateMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/common.ReplicationService/ReplicateMessage',
            replication__pb2.ReplicationRequest.SerializeToString,
            replication__pb2.ReplicationResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Ping(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            replication__pb2.PingResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
